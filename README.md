# nvim-treesitter-queries-nickel

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-nickel/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-nickel/actions/workflows/validate.yml)

Neovim tree-sitter queries for **nickel**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-nickel",
...
- [ ] Changes are scoped to `nickel` — do not include files for other languages
